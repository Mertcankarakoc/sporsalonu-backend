...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(@Lazy JwtService jwtService, @Lazy JwtAuthenticationFilter jwtAuthenticationFilter, CustomUserDetailsService customUserDetailsService) {
